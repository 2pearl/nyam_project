...
public class ShareChatActivity extends AppCompatActivity {
    ...
    private DatabaseReference reference = FirebaseDatabase.getInstance()
            .getReference().child("Share message");
    ...
    private void afterchatout(){
        ...
        mDatabase.getReference().child("Share message").removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
        ...
        mDatabase.getReference().child("Share appointment").removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
            }
        }).addOnFailureListener(new OnFailureListener(){
    ...
    private void appointment(){
        ...
        DatabaseReference myRef = database.getReference("Share appointment").child("appoint");
        ...
        DatabaseReference myRefget = database.getReference("Share appointment");
